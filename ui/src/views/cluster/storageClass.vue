              ...
              <template slot-scope="scope">
                <el-dropdown size="medium" >
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item @click.native.prevent="getStorageClassYaml(scope.row.name)">
...
import { listStorageClass, getStorageClass } from '@/api/storage_class'
...
export default {
    ...
    computed: {
        storageClass: function() {
            let data = []
            console.log(this.originStorageClass)
